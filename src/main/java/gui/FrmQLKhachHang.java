...
public class FrmQLKhachHang extends JFrame {
    ...
    private void loadDataToJTable() {
        ...
        for (KhachHang kh : qlkh.getDsKhachHang()) {
            model.addRow(new Object[]{kh.getMaso(), kh.getHoten(), kh.getLoai() == 1 ? "Kinh Doanh" : "Sinh Hoat", kh.getChisocu(), kh.getChisomoi(),kh.getTieuThu(),kh.getTienTra()});
        }
    }
}
